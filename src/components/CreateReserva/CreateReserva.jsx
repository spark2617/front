...
import { useAuth } from "../../pages/Login/contexts/auth";
//  CONEXAO COM API    import { reservations } from "../../services/reservations";
//  CONEXAO COM API    import { UsersAPI } from "../../services/users";
import { DatePicker } from "../DataPicker/DatePicker";
import { toast } from "react-toastify";
import "./CreateReserva.scss";
  ...
  const handleSubmit = (event) => {
    ...
    <form className="reservation-form" onSubmit={handleSubmit}>
      ...
      <section className="reservation-hour">
        <h3>SOBRE O USO DO METAHOTEL</h3>
                    
          <p>
            Sua reserva estará disponível para você das{" "}
      ...
      <section className="reservation-details">
        <div>
          ...
          <div className="reservation-details__container">
              <img src={images.img[0].url} alt="Imagem principal do terreno" />
            ...
            <div className="reservation-details__text-content">
              ...
              <p className="reservation-details__title">
                Localização ({localizationX}, {localizationY})
              </p>
